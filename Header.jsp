<%@ page language="java" contentType="text/html; charset=EUC-KR"
    ...
    <body>
        <div id="wrap">
            <p>
                <button class="btn btn-success" onclick="changeView(0)">HOME</button> // 로그인 안되었을 경우 - 로그인, 회원가입 버튼을 보여준다.
             <%	if(session.getAttribute("sessionID")==null){ %>
                     <button id="loginBtn" class="btn btn-primary" onclick="changeView(1)">로그인</button>
                     <button id="joinBtn" class="btn btn-primary" onclick="changeView(2)">회원가입</button> // 로그인 되었을 경우 - 로그아웃, 내정보 버튼을 보여준다.
             <%	}else{ %>
